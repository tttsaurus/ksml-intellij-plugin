...
import com.tttsaurus.ksml.language.navigation.reference.resolver.KiGModuleCallReferenceResolver
import com.tttsaurus.ksml.language.utils.glsl.GlslModuleCallParser

class KiGModuleCallReferenceProvider : PsiReferenceProvider() {
    ...
    override fun getReferencesByElement(
        ...
        if (count <= 0) {
            return arrayOf(
                KiGModuleCallReferenceResolver(
                    0,
            ...
            for (i in 0 until count) {
                refs += KiGModuleCallReferenceResolver(
                    i,
                    moduleCall.moduleName,
                    element,
                    TextRange(0, moduleCall.moduleName.length),
